    ...
    const Gestion = {
        ...
        inicializarCheckpoints() {
            ...
            this.tablas.checkpoints = tabla.DataTable({
                ajax: {
                    url: '/ConfiguracionCheckPoint/ObtenerConfiguracionesCheckPoints',
                    type: 'GET',
        ...
        registrarEventos() {
            ...
            $('#formCrearPregunta').on('submit', function (e) {
                ...
                const formulario = $(this);
                const datos = {
                    Texto: formulario.find('[name=Texto]').val(),
                    ValorMinimo: parseInt(formulario.find('[name=ValorMinimo]').val()),
                    ValorMaximo: parseInt(formulario.find('[name=ValorMaximo]').val()),
                    UmbralAlerta: parseInt(formulario.find('[name=UmbralAlerta]').val()),
                    DireccionAlerta: parseInt(formulario.find('[name=DireccionAlerta]').val())
                };
                $.ajax({
                    url: '/api/PreguntasPOp',
                    type: 'POST',
            ...
            $('#formEditarPregunta').on('submit', function (e) {
                ...
                const datos = {
                    ...
                    Texto: $('#editPreguntaTexto').val(),
                    ValorMinimo: parseInt($('#editPreguntaMin').val()),
                    ValorMaximo: parseInt($('#editPreguntaMax').val()),
                    UmbralAlerta: parseInt($('#editPreguntaUmbral').val()),
            ...
            $('#formRegistrarRespuestas').on('submit', function (e) {
                e.preventDefault();
                const idSeguimiento = parseInt($('#respIdSeguimiento').val());
                const respuestas = [];
